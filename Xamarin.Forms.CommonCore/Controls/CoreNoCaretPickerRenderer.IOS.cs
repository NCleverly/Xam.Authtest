...
namespace Xamarin.Forms.CommonCore
{
    ...
    public class CoreNoCaretPickerRenderer : ViewRenderer<CorePicker, UITextField>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.CommonCore.CorePicker> e)
        {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == CorePicker.TextColorProperty.PropertyName || e.PropertyName == VisualElement.IsEnabledProperty.PropertyName)
            {
                UpdateTextColor();
            }
        }
